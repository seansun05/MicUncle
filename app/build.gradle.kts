...
android {
    namespace = "com.sean.micuncle"
    compileSdk {
        version = release(36)
    }

    defaultConfig {
        applicationId = "com.sean.micuncle"
        minSdk = 31
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // Media3 (ExoPlayer) fallback backend
    ...
    // IJKPlayer decoder backend (mavenCentral compatible coordinates)
